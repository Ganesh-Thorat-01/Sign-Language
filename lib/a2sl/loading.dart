...
import 'package:flutter_video_list_sample/main.dart';
       ...
       http.Response response = await http.post(
        ...
        if(response.statusCode==200){
            ...
            for(var i=0;i<output_clips.length;i++){
              clips.add({"title":"${output_clips[i]}", "fileName":"assets/${output_clips[i]}.mp4", "thumbName":"Thumbnail.png", "runningTime":3, "parent":"assets"});
            }

            Navigator.push(
            context,
                MaterialPageRoute(builder: (context) => PlayPage(clips: clips,sentence: sentence)),
          );
